...
Tsqared = T(X2_barra-X2_barra) %*% inv(frac*Spooled) %*% (X2_barra-X2_barra)

frac2 = (p*(n2+n3-2) ) / (n2+n3-p-1)

f_p_n_n = qf(1-alpha, p, n2+n3-p-1)

f_p_n_n_frac2 = f_p_n_n * frac2


#Si Tsqared es mayor a 45 entonces no se acepta la prueba de hipotesis con una confianza del 99%
