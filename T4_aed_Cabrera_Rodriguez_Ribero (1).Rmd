...
De esta forma, se tiene que el intervalo de confianza simultáneo del 95% para $\beta_{1} = [-0.84, 4.41]$, y para $\beta_0 = [-7.13, 3.26]$. Una de las razones de la amplitud de estos intervalos puede ser que $n$ es muy pequeño.
...
n_1 = length(X1_1)+length(X2_1)+length(X3_1)
n_2 = length(X1_2)+length(X2_2)+length(X3_2)
