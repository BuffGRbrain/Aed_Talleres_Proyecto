...
4,1. [Boxplots](#Boxplots)
4,2. [Matriz de correlación](#Matriz-de-correlacion)
4.2. [PCA](#PCA)
5. [Agrupamiento de los géneros musicales](#Agrupamiento-de-los-generos-musicales)
5,1. [Discriminante lineal de Fisher con datos puros](#Discriminante-lineal-de-Fisher-con-datos-puros)
5,2. [Discriminante lineal de Fisher con datos corregidos](#Discriminante-lineal-de-Fisher-con-datos-corregidos)
5,3. [Agrupamiento según nivel de popularidad](#Agrupamiento-segun-nivel-de-popularidad)
6. [Regresión lineal](#Regresion-lineal)
