...
```
Podemos observar como 'Loudness' y 'energy' aportan significativamente al componente principal 2. Si un data point tiene valores muy bajos en esas dos variables, estara ploteado en la izquiera del grafico, 
-------
